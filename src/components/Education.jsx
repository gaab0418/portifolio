...
export default function Education() {
  return (
    <StyledSection component="section" id="education" className="timeline education">
      <SectionHeading
        pill="Formação"
        title="Estudos que alimentam minha curiosidade infinita"
        description="Formação acadêmica e aprendizados contínuos para manter meus projetos alinhados com o estado da arte."
      />
      <StyledContainer>
